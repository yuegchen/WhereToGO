  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Reservations List by <%=firstname+" "+lastname%></h2>
        ...
        <div class="w3-responsive" style="width:700px; height:500px;">
              ...
              <tr>
                ...
                <th>Booking Fee</th>
                <th >Total Fare</th>
                <th >Customer-Representative AccountNo</th>
