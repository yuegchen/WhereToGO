  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
     ...
     <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Add a New Employee </h2>
        ...
        <div class="w3-responsive" style="width:700px; height:300px;overflow:auto;">
              ...
              <tr>
              	...
              	<input type="hidden" name = "type" value="employee">
  				 ...
  				 <input type="hidden" name="login" value=<%=login%>>
  				<td><button class="w3-button w3-dark-grey" type="submit"> Add</button> </td>  
               	<td><input class="w3-input w3-border" type="text"  name="ID" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="FirstName" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="LastName" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="Address" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="City" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="State" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="ZipCode" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="SSN" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="HourlyRate" required style="width: 100px;"></td>
