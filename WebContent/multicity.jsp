...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  ...
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-blue">
      <h2><i class=""></i>Search Flight--MultiCity</h2>
    </div>
     
    <div class="w3-container w3-white w3-padding-16">
      <form action="SearchFlightMultiCity" method="post">
        <div class="w3-row-padding" style="margin:0 -16px;">
          ...
          <div class="w3-half">
            <label><i class="fa fa-calendar-o"></i> Departing2</label>
            <input class="w3-input w3-border" type="text" placeholder="YYYY-MM-DD" name="Departing2" required>
          </div>
        </div>
        <div class="w3-row-padding" style="margin:8px -16px;">
          ...
          <input class="w3-input w3-border" type="text" placeholder="Destination" name="Destination" required>
                ...
                <div class="w3-row-padding" style="margin:8px -16px;">
          <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-city"></i> OriginCity2</label>
            <input class="w3-input w3-border" type="text" placeholder="Origin2" name="Origin2" required>
          </div>
          <div class="w3-half">
            <label><i class="fa fa-city"></i> DestinationCity2</label>
          <input class="w3-input w3-border" type="text" placeholder="Destination2" name="Destination2" required>
          </div>
        </div>
        <input type="hidden" name="login" value=<%=login%>>
