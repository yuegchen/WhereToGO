...
<!-- Header -->
<header class="w3-display-container w3-content" style="max-width:2000px;max-height: 2500px;min-width:1500px;min-height: 930px;">
  ...
  <div class="w3-display-left w3-padding w3-col l6 m8">
	...
	String arrId1 = (String) request.getAttribute("arrId1");
	 ...
	 String airId2 = (String) request.getAttribute("airId2");
		...
		double totalFare=Double.parseDouble(fare2)+Double.parseDouble(fare1);
		double totalBF=result1+result2;
  %>
      ...
      <form action="order" method="post">
        ...
        <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-calendar-check-o"></i> Depart From <br><%=departId2%>, <%=destination%></label>
            <div class="w3-container w3-section w3-light-blue">
  				<h4><%=depTime2%></h4>
			</div>
         </div>
         <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-calendar-check-o"></i> Estimated Arrive Time at<br> <%=arrId2%>, <%=origin%></label>
            <div class="w3-container w3-section w3-blue">
  				<h4><%=arrTime2%></h4>
			</div>
         </div>
        ...
        <h3><i class=""></i>In Total, Fare : <%=totalFare%>, Booking Fee: <%=totalBF%></h3>
        <input type="hidden" name="login" value=<%=login%>>
