...
<body class="w3-light-grey">
	  <%
     	String login=(String)request.getParameter("login");
	  	String cLogin =(String)request.getParameter("cFN")+(String)request.getParameter("cLN");
	  	String RepId= (String)request.getParameter("ID");
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Record the Reservation for <%=cLogin%> </h2>
        ...
        <div class="w3-responsive" style="width:700px; height:300px;overflow:auto;">
              ...
              <tr>
              	<form action="Customer_RepOrder" method="post">
  				 <input type="hidden" name="login" value=<%=cLogin%>>
  				 <input type="hidden" name="RepNo" value=<%=RepId%>>
  				 <input type="hidden" name="cID" value=<%=cID%>>
  				 <input type="hidden" name="type" value="employee">
  				<td><button class="w3-button w3-dark-grey" type="submit"> Submit</button> </td>  
               	<td><input class="w3-input w3-border" type="text"  name="airId" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="flightNo" required style="width: 100px;"></td>
                <td><input class="w3-input w3-border" type="text"  name="legNo" required style="width: 100px;"></td>
