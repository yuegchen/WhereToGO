  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>My bids </h2>
        ...
        <div class="w3-responsive" style="width:700px; height:500px;">
              ...
              <tr>
              	<form action="userAction" method="post">
  				 ...
  				 <input type="hidden" name="login" value=<%=login%>>
               	<td><input class="w3-input w3-border" type="text"  name="airlineId" required></td>
                <td><input class="w3-input w3-border" type="text"  name="flightNo" required></td>
                <td><input class="w3-input w3-border" type="text"  name="legNo" required></td>
                <td><input class="w3-input w3-border" type="text"  name="NYOP" required></td>
                <td><button class="w3-button w3-dark-grey" type="submit"><i class="fa fa-search w3-margin-right"></i> bid</button> </td>       
      			</form>
              </tr>
              <%
              	n++;
