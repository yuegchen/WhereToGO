...
<body class="w3-light-grey">
	  <%
     	String login=(String)request.getParameter("login");
	  	...
	  	String CreditCardNo=(String)request.getParameter("cCC");
	  	String Phone = (String)request.getParameter("cPH");
	  	String email = (String)request.getParameter("cEM");
	  	String CreationDate=(String)request.getParameter("cCD");
	  	String Rating=(String)request.getParameter("cRT");
	  	//String items = (String)request.getAttribute("items");
	  	
	  //	String[] bids=items.split(";");
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Edit Customer Information</h2>
        ...
        <div class="w3-responsive" style="width:700px; height:300px;overflow:auto;">
              ...
              <tr>
                ...
                <td><input class="w3-input w3-border" type="text"  name="cCreditCardNo"  style="width: 100px;" value=<%=CreditCardNo%>></td>
                <td><input class="w3-input w3-border" type="text"  name="cPhone"  style="width: 100px;" value=<%=Phone%>></td>
                <td><input class="w3-input w3-border" type="text"  name="cEmail"  style="width: 100px;" value=<%=email%>></td>
                <td><input class="w3-input w3-border" type="text"  name="cCreationDate"  style="width: 100px;" value=<%=CreationDate%>></td>
                <td><input class="w3-input w3-border" type="text"  name="cRating"  style="width: 100px;" value=<%=Rating%>></td>
