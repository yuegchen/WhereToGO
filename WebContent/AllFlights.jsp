  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>All Flights </h2>
        ...
        <div class="w3-responsive" style="width:700px; height:500px;">
              ...
              <%
              int i = flights.length;
              if(items.equals(""))
            	  i=0;
              int n=0;
              while(n<i){
            	 
            	  //SELECT F.AirlineID,F.FlightNo,F.NoOfSeats,F.DaysOperating,F.MinLengthOfStay,F.MaxLengthOfStay
            	  //FROM flight F;
              %>
              <tr>
              	 
               	<td><%=(flights[n].split(","))[0]%> </td>
                <td><%=(flights[n].split(","))[1]%></td>
                <td><%=(flights[n].split(","))[2]%></td>
                <td><%=(flights[n].split(","))[3]%></td>
                <td><%=(flights[n].split(","))[4]%></td>
                <td><%=(flights[n].split(","))[5]%></td>
